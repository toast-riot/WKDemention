...
## What Happens?
A timer of 6 minutes is given. Once this timer ends, a flash will appear and your screen will freeze. The screen will then fade to a new frame showing a previous memory.
...
* The mod has been released to all